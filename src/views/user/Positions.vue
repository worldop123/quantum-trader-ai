<template>
  <div class="space-y-6">
    ...
    <div class="quantum-card flex flex-wrap items-center gap-4">
      ...
      <select v-model="filterType" class="quantum-input w-32 text-sm">
        ...
        <tbody>
          <tr v-for="position in filteredPositions" :key="position.id" 
            ...
            <td class="py-3 px-4 text-right font-mono font-medium"
              :class="position.pnl >= 0 ? 'text-quantum-green' : 'text-quantum-red'">
            ...
            <td class="py-3 px-4 text-center">
              <button @click="closePosition(position.id)" class="text-quantum-red hover:text-red-400 text-sm">
                平仓
              </button>
            </td>
          </tr>
